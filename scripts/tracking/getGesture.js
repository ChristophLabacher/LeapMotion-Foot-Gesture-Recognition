...
function getSwipeVel()	{
	...
	if (movementXHistoryLength > 2)	{
		...
		// SWIPE RIGHT
		// If the last three movements were right, left, none.
		} else if (movementXHistory[movementXHistoryLength - 1].direction == "right" && movementXHistory[movementXHistoryLength - 1].velocity > 1.3 && movementXHistory[movementXHistoryLength - 1].distance > 100)	{
